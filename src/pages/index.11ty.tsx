                ...
                <div>
                  ...
                  <div className="flex flex-col items-start justify-between gap-x-[200px] xl:flex-row xl:items-center">
                    ...
                    <div className="mb-3 flex flex-wrap gap-6">
                      ...
                      <a href="#" className="btn is-outline-black btn-animation is-large inline-block rounded-[3px]"><span>View Our Services</span></a>
                    </div>
                  </div>
                </div>
                {/* Hero Area */}
            ...
            <div className="container-default">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="jos rounded-[10px] bg-white p-10 shadow-[0_4px_80px_0px_rgba(0,0,0,0.06)]" data-jos_delay="0">
                  <div className="mb-[5px] font-Syne text-6xl font-semibold uppercase leading-[1.5] text-[#00F] lg:text-7xl xl:text-[90px]" data-module="countup">
                    <span className="start-number text-black" data-countup-number="15">15</span>+
                  </div>
                ...
                <div className="jos rounded-[10px] bg-white p-10 shadow-[0_4px_80px_0px_rgba(0,0,0,0.06)]" data-jos_delay="0.3">
                  <div className="mb-[5px] font-Syne text-6xl font-semibold uppercase leading-[1.5] text-[#00F] lg:text-7xl xl:text-[90px]" data-module="countup">
                    <span className="start-number text-black" data-countup-number="2">2</span>M+
                  </div>
                  <span className="text-lg text-black lg:text-xl">Worked with 2M clients in different countries around the
                    world</span>
                </div>
                {/* Fun-fact Single Block */}
                {/* Fun-fact Single Block */}
                <div className="jos rounded-[10px] bg-white p-10 shadow-[0_4px_80px_0px_rgba(0,0,0,0.06)]" data-jos_delay="0.6">
                  <div className="mb-[5px] font-Syne text-6xl font-semibold uppercase leading-[1.5] text-[#00F] lg:text-7xl xl:text-[90px]" data-module="countup">
                    <span className="start-number text-black" data-countup-number="99">99</span>%
                  </div>
                  <span className="text-lg text-black lg:text-xl">About 99% of our clients express their satisfaction with
                    our work</span>
                </div>
                {/* Fun-fact Single Block */}
              </div>
                  ...
                  <div className="jos">
                    <div className="group flex h-full flex-col items-start justify-between gap-10 gap-x-[50px] rounded-[5px] border border-[#414141] p-10 md:flex-row md:items-center lg:gap-x-10">
                      ...
                      <a href="service-details.html" className="relative flex h-[43px] w-[43px] items-center justify-center overflow-hidden">
                        <img src="/assets/img/icons/icon-white-top-right.svg" alt="icon-white-top-right" width="43" height="43" className="absolute inset-0 transition-all duration-300 group-hover:-translate-y-full group-hover:translate-x-full" />
                        <img src="/assets/img/icons/icon-blue-top-right.svg" alt="icon-blue-top-right" width="43" height="43" className="absolute inset-0 -translate-x-full translate-y-full transition-all duration-300 group-hover:translate-x-0 group-hover:translate-y-0" />
                      </a>
                    </div>
                  </div>
                  {/* Service Item */}
              ...
              <div className="flex flex-col gap-y-20 lg:gap-y-[100px] xl:gap-y-[120px]">
                ...
                <div className="grid items-center gap-10 lg:grid-cols-[0.7fr_minmax(0,_1fr)] lg:gap-24 xl:gap-[110px]">
                  ...
                  <div className="jos order-1 lg:order-2" data-jos_animation="fade-right">
                    ...
                    <a href="#" className="btn is-blue is-transparent btn-animation is-large group mt-8 inline-block rounded-[3px]">
                  ...
                  <div className="jos" data-jos_animation="fade-right">
                    ...
                    <ul className="flex list-inside flex-col gap-y-8 text-lg leading-[1.33] -tracking-[0.5px] text-[#2C2C2C] md:text-xl xl:text-2xl">
                      ...
                      <li className="flex gap-x-[10px]">
                        <span className="mr-3 mt-[3px] text-[#0000FF]"><i className="fa-solid fa-circle-check"></i></span>
                        <p>
                    ...
                    <div className="jos" data-jos_animation="fade-left">
                      <div className="max-w-[789px]">
                        ...
                        <div className="mt-8 lg:mt-[50px]">
                          <a href="#" className="btn is-outline-white btn-animation is-large inline-block rounded-[3px]"><span>View Our Services</span></a>
                        </div>
                  ...
                  <div className="jos rounded-[5px] bg-white p-10" data-jos_animation="fade-right">
                    <form action="#" method="post" className="flex flex-col gap-y-6">
                      <div className="flex flex-col">
                        <label htmlFor="cta-name" className="mb-[10px] font-semibold text-black">Your name</label>
                        <input type="text" name="cta-name" id="cta-name" className="rounded-[5px] border border-[#B8C1CC] px-4 py-2 outline-none transition-all duration-150 focus:border-[#0000FF] focus:text-black lg:px-[30px] lg:py-[15px]" placeholder="Enter your full name" required />
                      </div>
                      <div className="flex flex-col">
                        <label htmlFor="cta-email" className="mb-[10px] font-semibold text-black">Email address</label>
                        <input type="email" name="cta-email" id="cta-email" className="rounded-[5px] border border-[#B8C1CC] px-4 py-2 outline-none transition-all duration-150 focus:border-[#0000FF] focus:text-black lg:px-[30px] lg:py-[15px]" placeholder="Enter your email" required />
                      </div>
                      <div className="flex flex-col">
                        <label htmlFor="cta-service" className="mb-[10px] font-semibold text-black">Email address</label>
                        <select name="cta-service" id="cta-service" className="rounded-[5px] border border-[#B8C1CC] px-4 py-2 outline-none transition-all duration-150 focus:border-[#0000FF] focus:text-black lg:px-[30px] lg:py-[15px]" required>
                      ...
                      <div className="flex flex-col">
                        <label htmlFor="cta-message" className="mb-[10px] font-semibold text-black">Write your message</label>
                        <textarea name="cta-message" id="cta-message" className="min-h-[120px] w-full rounded-[5px] border border-[#B8C1CC] px-4 py-2 outline-none transition-all duration-150 focus:border-[#0000FF] focus:text-black lg:px-[30px] lg:py-[15px]" placeholder="Write us your question here..." required></textarea>
                      </div>

                      <button type="submit" className="btn is-large rounded-[3px] border-[#0000FF] bg-[#0000FF] text-white hover:bg-white hover:text-[#0000FF]">
                        Send Message
                      </button>
                    </form>
                  </div>
            ...
            <div className="container-default">
              <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-5 md:justify-between">
                ...
                <div className="text-center">
                  &copy; Copyright 2025, All Rights Reserved by Hip Dot Media, Inc.
                </div>
              </div>
            </div>
            {/* Section Container */}
