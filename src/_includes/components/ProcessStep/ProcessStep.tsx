...
export default function ProcessStep({ stepNumber, title, description, delay = 0 }: ProcessStepProps) {
  return (
    <div className="jos group relative lg:pt-[30px]" data-jos_delay={delay}>
      <div className="mb-6 font-Syne text-3xl font-semibold leading-none text-black dark:text-white lg:text-[26px] xl:text-3xl xxl:text-[35px]">
        {stepNumber}. {title}
      </div>
      <p className="m-0 text-lg leading-[1.33] -tracking-[0.5px] text-[#2C2C2C] dark:text-white/70 md:text-xl xl:text-2xl">
        {description}
      </p>
